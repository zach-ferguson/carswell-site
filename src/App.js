    ...
    <Box className="App"
      ...
      <Navbar />
        ...
        <CardMedia sx={{ position: 'fixed',  width: '400px', top: '50%', left: '50%', marginLeft: '-200px', marginTop: '-225px'}}>
          <iframe style={{ borderRadius: '12px', opacity: '.9' }} src="https://open.spotify.com/embed/playlist/7whoqO8hn717qz31qJ61mz?utm_source=generator&theme=0" width='100%' height='450px' allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" />
        </CardMedia>
